                    ...
                    renderItem={(ws) => (
                        <div className="flex justify-between items-start">
                            <div className="min-w-0 flex-1">
                                ...
                                />
                                <div className="text-[11px] opacity-40">{ws.course_count} courses</div>
                            </div>
                    ...
                    renderItem={(c) => (
                        <div className="flex justify-between items-start">
                            <div className="min-w-0 flex-1">
                                ...
                                />
                                <div className="text-[11px] opacity-40">{c.subject_count} subjects</div>
                            </div>
                        ...
                        <div className="flex justify-between items-start">
                            <div className="flex items-start gap-2 min-w-0 flex-1">
                                ...
                                <div className="min-w-0">
                                    ...
                                    />
                                    <div className="text-[11px] opacity-40">{s.document_count} docs · {s.topic_count || 0} topics</div>
                                </div>
                            </div>
                    ...
                    renderItem={(t) => (
                        <div className="flex justify-between items-start">
                            <div className="min-w-0 flex-1">
                                ...
                                />
                                <div className="text-[11px] opacity-40">{t.document_count} docs</div>
                            </div>
                ...
                <div className="card space-y-4">
                    <div className="flex items-center justify-between">
                        <h2 className="text-lg font-semibold text-surface-100">
                            📄 Documents <span className="text-xs font-normal text-surface-200/40">({docs.length})</span>
                        </h2>
                                ...
                                <div key={doc.id} className="flex items-center justify-between bg-surface-900/40 rounded-lg px-4 py-3 border border-surface-700/20">
                                    <div className="flex items-center gap-3 min-w-0">
                                        ...
                                        <div className="min-w-0">
                                            ...
                                            <div className="text-[11px] text-surface-200/40">
    ...
    return (
        <div className="space-y-1.5">
            <div className="flex items-center justify-between mb-2">
                <h3 className="text-[11px] font-bold uppercase tracking-widest text-surface-200/40">{title}</h3>
